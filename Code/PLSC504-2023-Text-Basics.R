...
GBA.3<-read_file("https://raw.githubusercontent.com/PrisonRodeo/PLSC504-2023-git/main/Data/GBA.txt")
GBA.3

# And the same from the web-version of the PDF:

GBA.4<-pdf_text("https://github.com/PrisonRodeo/PLSC504-2023-git/raw/main/Data/GBA.pdf")
GBA.4
...
eng<-tesseract("eng")
GBA.5<-tesseract::ocr("https://github.com/PrisonRodeo/PLSC504-2023-git/raw/main/Data/GBA.png",
                      engine = eng)
cat(GBA.5)

# Now reading from a hand-written image file:

GBA.6<-tesseract::ocr("https://github.com/PrisonRodeo/PLSC504-2023-git/raw/main/Data/GBA-CZ.png",
                       engine = eng)
cat(GBA.6)
...
req<-GET("https://api.github.com/repos/PrisonRodeo/PLSC504-2023-git/contents/Data/LD-Debates")
...
for(i in 1:length(fnames)){
  fn<-paste0("https://github.com/PrisonRodeo/PLSC504-2023-git/raw/main/Data/LD-Debates/",
             fnames[i])
  f<-pdf_text(fn)
  out<-paste0("LD",i)
  assign(out,f)

...
UN <- read.csv("https://github.com/PrisonRodeo/PLSC504-2023-git/raw/main/Data/UNHCRSpeeches.csv")
...
# You can also do that using -system-:
...
GBA<-read_file("https://raw.githubusercontent.com/PrisonRodeo/PLSC504-2023-git/main/Data/GBA.txt")
